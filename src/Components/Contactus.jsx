...
const Contactus = () => {
 ...
 async  function validate(e) {
    ...
    if (data.name === "") {
      ...
      await axios.post("http://localhost:3600/feedback", data);
        ...
        <div className="col-md-6">
          <div className="row">
            <form onSubmit={validate}>
              ...
              />
              <p style={{ color: "red",fontSize:"12px", fontFamily: "sans-serif",position:"fixed" }}>
                {issue.name}
              </p>
              ...
              />
              <p style={{ color: "red", fontFamily: "sans-serif",fontSize:"12px",position:"fixed" }}>
                {issue.email}
              </p>
              ...
              <button className="offset-md-3 col-md-3 mt-4 text-center">Send</button>
            </form>
          </div>
        </div>
      </div>
